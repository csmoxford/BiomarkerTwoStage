...
dfnames = c("Design","P(+)","P(b-)","P(b+)","interim stop","interim unselected","interim positive","Futility","Success (b+)","Success (b- & b+)","mean SS","99% SS","mean tested")
...
balancedData = df
save(balancedData, file = paste0(programDir,"BalancedStaggeredData_02Feb2018.rData"))
